defmodule Aoc2024.Day01 do
  ...
  This module solves a problem where we need to compare two lists of numbers and calculate the total distance between them.

  The problem happens when two lists of numbers, written as columns in a text, seem to not match well when you compare them side by side.
  ...
  @doc """
  Solves the problem by reading the input from a file and printing the total distance.
